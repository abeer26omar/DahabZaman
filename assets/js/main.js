(function ($) {
	...
	const testiswiper = new Swiper('.testimonial-five-slider-active', {
	  ...
	  const productswiper = new Swiper('.tp-products-slider-active', {
		// Optional parameters
		loop: true,
		slidesPerView: 4,
        spaceBetween: 20,
	  ...
	  const smallproductswiper = new Swiper('.tp-small-products-slider-active', {
		// Optional parameters
		loop: true,
		slidesPerView: 3,
        spaceBetween: 20,
	...
	$('.tp-hero-slider-active').on('afterChange', function(event, slick, currentSlide){
		// $('.slick-active').addClass('wow animate__fadeInUp');
		// $('.slick-active').find('.animate-me').addClass('animate__animated');
		new WOW().init();
	  });

	// 09. Hero-1-Slider js
	$('.tp-hero-slider-active').slick({
		slidesToShow: 1,
		slidesToScroll: 1,
		dots: false,
		arrows: false,
